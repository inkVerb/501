...
while ($row = mysqli_fetch_array($call, MYSQLI_NUM)) {
  ...
  <span id="pstatus'.$p_id.'">'.$p_status.'</span><i id="pdeleting'.$p_id.'" style="display: none;">trashed &#10008;</i> <code onclick="clearChanged('.$p_id.')" title="dismiss" style="float: right; cursor: pointer; display: none;" id="changed_'.$p_id.'">&nbsp;changed&nbsp;</code><br>
