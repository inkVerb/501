...
// Remove our "Remember me" username cookie
unset($_COOKIE['remember_user']); // Unset the cookie so if tests don't find it later
setcookie('username', null, 86401); // Set our cookie value to "null" (nothing) and expire in Jan 1970
