<?php
  ...
  // Delete checkbox
  if ( (!empty($_POST['deletefruit'])) && (!empty($_POST['fruitid'])) &&
     (($_POST['deletefruit']) == ($_POST['fruitid'])) ) {
    $delete_fruit = $_POST['fruitid'];
    return; // Exit this entire included file and don't do anything after this line
    // We want to quit now so we don't need to do our other checks
  }
