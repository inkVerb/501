...
// Must be set:
$form_id = 'edit_piece';
$edit_piece_id = (isset($piece_id)) ? $piece_id : '';
...
echo '<input form="'.$form_id.$edit_piece_id.'" type="hidden" name="piece"><br>';
...
// Two submit buttons
echo '<input form="'.$form_id.$edit_piece_id.'" type="submit" name="p_submit" value="Save draft">';
...
if ((isset($editing_existing_piece)) && ($editing_existing_piece == true)) {
  ...
  if ((isset($editing_published_piece)) && ($editing_published_piece == true)) {
    echo '<input form="'.$form_id.$edit_piece_id.'" type="submit" name="p_submit" value="Update">';
  } else {
    echo '<input form="'.$form_id.$edit_piece_id.'" type="submit" name="p_submit" value="Publish">';
  }
}
// New line
echo '<br><br>';
...
echo '
  ...
  function showGoLiveOptionsBox'.$piece_id.'() {
    var x = document.getElementById("goLiveOptions'.$piece_id.'");
  ...
  function showGoLiveOptionsLabel'.$piece_id.'() {
    ...
    var y = document.getElementById("p_live_schedule_'.$edit_piece_id.'");
    if (y.checked === false) {
      y.checked = true;
    } else {
      y.checked = false;
