...
function checkPiece($name, $value) {
  ...
  if ($name == 'p_title') {
    ...
    $result = substr($result, 0, 4294967290); // Limit to 4,294,967,290 characters for LONGTEXT datatype
  ...
  // Meta
    ...
    $result = substr($result, 0, 55530); // Limit to 55,530 characters to stay safe within TEXT datatype after JSON conversion
    ...
    $p_links_check = str_replace('-- ','—',$p_links_check); // to em-dash
    $p_links_check = str_replace('--','—',$p_links_check); // to em-dash
    $p_links_check = substr($p_links_check, 0, 55530); // Limit to 55,530 characters to stay safe within TEXT datatype after JSON conversion
...
function pieceInput($name, $value) {
  ...
  if ($name == 'p_title') {
    ...
    $result = '<input form="edit_piece" type="text" class="piece" id="p_subtitle" name="p_subtitle" placeholder="Subtitle..." maxlength="90" value="'.$value.'" onchange="onNavWarn();" onkeyup="onNavWarn();">';
  ...
  // Meta
    ...
    $result = '<textarea form="edit_piece" class="meta piece" id="p_links" name="p_links" onchange="onNavWarn();" onkeyup="onNavWarn();">'.$value.'</textarea>';
