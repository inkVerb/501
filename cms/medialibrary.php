      			...
      			<table>
      				<tr>
      					<td>
      						...
      						echo "\" title=\"Page 1\" href=\"$blog_web_base/medialibrary.php?r=1\">&laquo;</a>
      					</td>
      					<td>
      						<a class=\"paginate";
                  if ($paged == 1) {echo " disabled";}
                 echo "\" title=\"Previous\" href=\"$blog_web_base/medialibrary.php?r=$prevpaged\">&lsaquo;&nbsp;</a>
      					</td>
      					<td>
      						<a class=\"paginate current\" title=\"Next\" href=\"$blog_web_base/medialibrary.php?r=$paged\">Page $paged ($totalpages)</a>
      					</td>
      					<td>
      						<a class=\"paginate";
                  if ($paged == $totalpages) {echo " disabled";}
                 echo "\" title=\"Next\" href=\"$blog_web_base/medialibrary.php?r=$nextpaged\">&nbsp;&rsaquo;</a>
      					</td>
      					 <td>
      						 <a class=\"paginate";
      						 if ($paged == $totalpages) {echo " disabled";}
      	 					echo "\" title=\"Last Page\" href=\"$blog_web_base/medialibrary.php?r=$totalpages\">&raquo;</a>
      					 </td>
      		 		</tr>
      			</table>
      		</div>
