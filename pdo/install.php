...
EOF;
    ...
    $query = "CREATE TABLE IF NOT EXISTS `pieces` (
      ...
      `series_lang` VARCHAR(8) NOT NULL,
      `series_link` TEXT NOT NULL,
      `series_author` VARCHAR(90) NOT NULL,
      `series_descr` VARCHAR(255) NOT NULL,
      `series_summary` VARCHAR(255) NOT NULL,
      `series_owner` VARCHAR(255) NOT NULL,
      `series_email` VARCHAR(255) NOT NULL,
      `series_keywords` TEXT NOT NULL,
      `series_explicit` BOOLEAN NOT NULL DEFAULT false,
      `series_cat1` VARCHAR(255) NOT NULL,
      `series_cat2` VARCHAR(255) NOT NULL,
      `series_cat3` VARCHAR(255) NOT NULL,
      `series_cat4` VARCHAR(255) NOT NULL,
      `series_cat5` VARCHAR(255) NOT NULL,
      `series_copy` VARCHAR(90) NOT NULL,
      `series_credit` VARCHAR(90) NOT NULL,
